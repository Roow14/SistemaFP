            ...
            <div class="modal">
                <div class="modal-content" style="max-width: 600px; margin: auto;">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="apagar-arquivo-exame-2.php?id_paciente=<?php echo $id_paciente;?>&id_exame=<?php echo $id_exame;?>&id_midia_exame=<?php echo $id_midia_exame;?>&ArquivoMidia=<?php echo $ArquivoMidia;?>" class="btn btn-danger">Apagar</a>
                    </div>
                </div>
            </div>
        </div>
