...
if ($resultZ->num_rows > 0) {
    ...
    while($rowZ = $resultZ->fetch_assoc()) {
		// tem
		$id_paciente = $rowZ['id_paciente'];
		$NomeCompleto = $rowZ['NomeCompleto'];
		$Hora = $rowZ['Hora'];
		$id_agenda_paciente = $rowZ['id_agenda_paciente'];
		$Convenio = $rowZ['Convenio'];
		$NomeCategoria = $rowZ['NomeCategoria'];
		$id_convenio = $rowZ['id_convenio'];
		$Presenca = $rowZ['Presenca'];
		if ($Presenca == 1) {
