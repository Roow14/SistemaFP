...
$sqlC = "SELECT COUNT(id_profissional) AS Soma FROM agenda_paciente_base WHERE id_paciente = '$id_paciente' AND Data = '$Data' AND id_hora = '$id_hora' AND id_categoria = '$id_categoria'";
