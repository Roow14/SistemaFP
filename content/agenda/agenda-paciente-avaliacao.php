...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <div id="" style="padding: 0 25px;">
        	<h3>Pacientes em Avaliação</h3>

			<!-- cadastro do paciente -->
			<div style="margin-bottom: 15px;">
				<form action=agenda-base-paciente%20-%20Copia.php method="post" class="form-inline" style="margin-bottom: 5px;">
                ...
                <div class="form-grupo">
                    <form action="../paciente/cadastrar-paciente.php" method="post" class="form-inline" style="margin-bottom: 5px;">
                    <button type="submit" class="btn btn-successs">Cadastrar</button>
                </div>
                </form>
			</div>
		</div>
