...
<div>
	...
	<form action="agenda-base-paciente-filtro-2.php" method="post" class="form-inline" style="margin-bottom: 5px;">
		...
		<a href="agenda-base-paciente-limpar-filtro-2.php" class="btn btn-default">Limpar filtro</a>
		<a href="agenda-base-paciente-ativar-filtro-2.php" class="btn btn-default">Fechar</a>
	</form>
