        ...
        <div id="" style="padding: 0 25px;">
        	<div class="cabecalho">
        		...
        		<span class="hidden-print form-group">
					...
					<span data-toggle="tooltip" title="Ver dados do terapeuta"><a href="../profissional/profissional.php?id_profissional=<?php echo $id_profissional;?>" class="btn btn-default">Dados</a></span>
					...
					<a href="agenda-paciente-ativar-remocao-paciente.php?id_profissional=<?php echo $id_profissional;?>" class="btn btn-default" data-toggle="tooltip" title="Ativar / desativar botão para cancelar criança">&#x2715;</a>
