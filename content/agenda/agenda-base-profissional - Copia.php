        ...
        <div style="padding: 0 25px;">
        	<div class="cabecalho">
        		...
        		<span class="hidden-print form-group">
					...
					<a href="agenda-base-profissional-ativar-remocao-paciente.php?id_profissional=<?php echo $id_profissional;?>" class="btn btn-default" data-toggle="tooltip" title="Ativar / desativar botão para cancelar criança">&#x2715;</a>
