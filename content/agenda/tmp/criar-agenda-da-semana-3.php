...
// buscar xxx
$sqlA = "SELECT * FROM agenda_paciente WHERE DiaSemana = '$DiaSemana'";
...
if ($resultA->num_rows > 0) {
    while($rowA = $resultA->fetch_assoc()) {
		...
		// inserir
		$sqlB = "INSERT INTO agenda_paciente_real (id_paciente, id_profissional, id_unidade, id_categoria, id_hora, id_periodo, Data, DiaSemana) VALUES ('$id_paciente', '$id_profissional', '$id_unidade', '$id_categoria', '$id_hora', '$id_periodo', '$Data', '$DiaSemana')";
