...
$sql = "SELECT * FROM agenda_paciente WHERE id_paciente = '$id_paciente' AND id_unidade = '$id_unidade' AND DiaSemana = '$DiaSemana' AND id_hora = '$id_hora'";
...
if ($result->num_rows > 0) {
	...
	$sqlA = "INSERT INTO agenda_paciente (id_paciente, id_unidade, DiaSemana, id_hora, id_periodo, id_categoria, id_profissional) VALUES ('$id_paciente', '$id_unidade', '$DiaSemana', '$id_hora', '$id_periodo', '$id_categoria', '$id_profissionalPesq')";
