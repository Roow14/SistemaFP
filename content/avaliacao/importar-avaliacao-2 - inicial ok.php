...
$Origem = 'index.php?id_paciente='.$id_paciente;
$Vault = 1; // avaliação
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    // buscar xxx
    $sql = "SELECT * FROM midia WHERE ArquivoMidia = '$ArquivoMidia' AND Vault = 1 AND id_paciente = '$id_paciente'";
    ...
    $sql = "INSERT INTO midia (ArquivoMidia, id_paciente, Vault)
    VALUES ('$ArquivoMidia', '$id_paciente', '$Vault')";
