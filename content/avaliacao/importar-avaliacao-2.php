...
$target_dir = '../../vault/avaliacao/'.$id_paciente.'/';
$target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]);

$id_avaliacao = $_POST['id_avaliacao'];
$Origem = 'alterar-avaliacao.php?id_avaliacao='.$id_avaliacao;
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    // buscar xxx
    $sql = "SELECT * FROM midia_avaliacao WHERE ArquivoMidia = '$ArquivoMidia' AND id_midia_paciente = '$id_midia_paciente'";
    ...
    $sql = "INSERT INTO midia_avaliacao (ArquivoMidia, id_paciente, id_avaliacao)
