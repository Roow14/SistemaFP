...
$sql = "SELECT * FROM agenda_profissional WHERE id_profissional = '$id_profissional'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
    	// tem
...
<div class="row">
	...
	if (empty($_SESSION['AtivarAlteracaoProfissional'])) {
		...
		<div class="col-lg-6">
			...
			<a href="ativar-alteracao-dados-profissional.php?id_profissional=<?php echo $id_profissional;?>" class="btn btn-default">Alterar dados</a>
			<a href="agenda-profissional.php?id_profissional=<?php echo $id_profissional;?>" class="btn btn-default">Agenda do profissional</a>
		...
		<div>
			...
			if (empty($_SESSION['AtivarAdicaoProfissional'])) {
				...
				<div style="clear: both;" class="col-lg-6">
					...
					<form action="adicionar-categoria-profissional.php?id_profissional=<?php echo $id_profissional;?>" method="post" class="">
