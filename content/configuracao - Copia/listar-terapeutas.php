...
if (isset($_POST['NomeTerapeuta'])) {
	...
	$FiltroNomeTerapeuta = 'AND NomeCompleto LIKE "%'.$NomeTerapeuta.'%"';
...
<form action="" method="post" class="form-inline">
	...
	<a href="listar-terapeutas.php?Limpar=1" class="btn btn-default">Limpar filtro</a>
</form>
<br>
<?php
// buscar xxx
$sql = "SELECT * FROM profissional $FiltroStatus $FiltroNomeTerapeuta AND (Nivel = 1 OR Nivel = 2) ORDER BY NomeCompleto ASC";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		echo '<td><a href="../profissional/profissional.php?id_profissional='.$id_profissional.'" class="Link">'.$NomeCompleto.'</a></td>';
