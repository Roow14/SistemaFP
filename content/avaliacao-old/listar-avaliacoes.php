    ...
    <div id="content">
        ...
        <div id="conteudo">
            ...
            <div style="margin-bottom: 15px;">
                ...
                ?>
                <a href="" class="btn btn-default" data-toggle="modal" data-target="#Cadastrar">Cadastrar avaliação</a>
            ...
            <div class="row">
                <div class="col-sm-8">                	
                	...
                	if ($result->num_rows > 0) {
                	    while($row = $result->fetch_assoc()) {
                			...
                			<a href="alterar-avaliacao.php?id_paciente=<?php echo $id_paciente;?>&id_avaliacao=<?php echo $id_avaliacao;?>" class="btn btn-default">Alterar</a>
                			</div>
                			<?php
                	    }
                	} else {
                ...
                <div class="col-sm-4 ">
                    ...
                    <div class="">
                        <?php
                        // buscar xxx
                        $sql = "SELECT * FROM midia_avaliacao WHERE id_paciente = '$id_paciente' ORDER BY ArquivoMidia ASC";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo '<td style="width: 50px;"><a href="apagar-arquivo-avaliacao.php?id_midia_avaliacao='.$id_midia_avaliacao.'&ArquivoMidia='.$ArquivoMidia.'&id_paciente='.$id_paciente.'" class="btn btn-default">Apagar</a></td>';
                                echo '</tr>';
                            }
                            echo '</tbody>';
                            echo '</table>';
