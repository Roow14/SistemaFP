        ...
        <div id="conteudo">
            ...
            <div class="alert alert-danger">
                ...
                <div style="margin-top: 15px;">
                    ...
                    <a href="apagar-arquivo-avaliacao-2.php?id_paciente=<?php echo $id_paciente;?>&id_midia_avaliacao=<?php echo $id_midia_avaliacao;?>&ArquivoMidia=<?php echo $ArquivoMidia;?>" class="btn btn-danger">Apagar</a>
                </div>
            </div>
