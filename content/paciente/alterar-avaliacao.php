	...
	<div>
		...
		<form action="alterar-avaliacao-2.php?id_paciente=<?php echo $id_paciente;?>&id_avaliacao=<?php echo $id_avaliacao;?>" method="post" style="margin-bottom: 25px;">
			...
			<div class="form-group">
				...
				<textarea rows="15" class="form-control" name="Avaliacao"><?php echo $Avaliacao;?></textarea>
			</div>
			<a href="listar-avaliacoes.php?id_paciente=<?php echo $id_paciente;?>" class="btn btn-default">Voltar</a>
