    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div id="conteudo">
                ...
                <h3>Importar imagem</h3>
                <!-- <a href="" class="btn-icon" data-toggle="modal" data-target="#myModal-Ajuda"><i class="material-icons" data-toggle="tooltip" data-placement="top" title="Ajuda">help_outline</i></a> -->

                <form action="importar-foto-paciente-2.php" method="post" class="form-inline" enctype="multipart/form-data">
