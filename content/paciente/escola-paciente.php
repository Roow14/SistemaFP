...
<div class="janela">
	...
	if ($result->num_rows > 0) {
	    while($row = $result->fetch_assoc()) {
			...
			echo '<a href="escola.php?id_escola='.$id_escola.'" class="btn btn-default">Ver</a>';
			echo '<a href="remover-escola-do-paciente.php?id_escola_paciente='.$id_escola_paciente.'" class="btn btn-default">Remover escola</a><br><br>';
	    }
	} else {
