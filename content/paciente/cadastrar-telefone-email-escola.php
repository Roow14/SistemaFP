...
<div class="row">
	...
	<label>Nome da escola:</label> <?php echo $NomeEscola;?><br>

	<div class="row">
	
		<div class="col-lg-6">
			<h3>Cadastrar</h3>
			<form action="adicionar-telefone-email-escola-2.php?id_escola=<?php echo $id_escola;?>" method="post">
				<table class="table table-striped table-hover table-condensed">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" class="form-control" name="NotaTel" placeholder="Responsável"></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="form-control" name="NotaCel" placeholder="Responsável"></td>
						</tr>

						<tr>
							<td><label>E-mail:</label></td>
							<td><input type="text" class="form-control" name="EmailEscola"></td>
							<td><input disabled type="text" class="form-control" name=""></td>
							<td><input type="text" class="form-control" name="NotaEmail" placeholder="Responsável"></td>
						</tr>
					</tbody>
				</table>

				<a href="escola.php?id_escola=<?php echo $id_escola;?>" class="btn btn-default">Fechar</a>
		...
		<div class="col-lg-6">
			...
			if ($result->num_rows > 0) {
			    ...
			    while($row = $result->fetch_assoc()) {
					...
					echo '<form action="alterar-telefone-escola-2.php?id_escola='.$id_escola.'&id_telefone_escola='.$id_telefone_escola.'" method="post">';
					echo '<tr>';
					...
					echo '<a href="apagar-telefone-escola-2.php?id_escola='.$id_escola.'&id_telefone_escola='.$id_telefone_escola.'" class="btn btn-default">&#x2715;</a>';
					echo '</td>';
					echo '</tr>';
					echo '</form>';
			    }
			...
			if ($result->num_rows > 0) {
			    ...
			    while($row = $result->fetch_assoc()) {
					...
					echo '<form action="alterar-email-escola-2.php?id_escola='.$id_escola.'&id_email_escola='.$id_email_escola.'" method="post">';
					echo '<tr>';
					echo '<td><input type="text" class="form-control" name="EmailEscola" value="'.$EmailEscola.'"></td>';

					echo '<td><input type="text" class="form-control" name="NotaEmail" value="'.$NotaEmail.'"></td>';
					echo '<td style="width: 100px;">';
					echo '<button type="submit" class="btn btn-default" style="margin-right: 5px;">&#x270E;</button>';
					echo '<a href="apagar-email-paciente-2.php?id_escola='.$id_escola.'&id_email_escola='.$id_email_escola.'" class="btn btn-default">&#x2715;</a>';
					echo '</td>';
					echo '</tr>';
					echo '</form>';
			    }
