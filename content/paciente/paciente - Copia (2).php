		...
		<div class="col-lg-4">
			...
			if ($_SESSION['UsuarioNivel'] > 1) {
			    ...
			    <div>
					...
					<a href="../convenio/convenio-paciente.php?id_paciente=<?php echo $id_paciente;?>" class="btn btn-default">Convênio médico</a>
				</div>
			    <?php
			} else {
				?>
...
<div class="modal fade" id="Apagar" role="dialog">
    <div class="modal-dialog">
    	...
    	if ($Check > 0) {
	        ...
	        <!-- Modal content-->
	        <div class="modal-content">
	            <form action="apagar-paciente-2.php?id_profissional=<?php echo $id_profissional;?>" method="post">
	                <div class="modal-header">
	                    <button type="button" class="close" data-dismiss="modal">&times;</button>
	                    <h4 class="modal-title">Apagar paciente</h4>
	                </div>
