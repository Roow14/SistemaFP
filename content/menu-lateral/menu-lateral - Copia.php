...
<nav id="sidebar" class="hidden-print">
    ...
    if ($_SESSION['UsuarioNivel'] > 1) {
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="#Agenda" data-toggle="collapse" aria-expanded="false">Agenda FP</a>
                <ul class="collapse list-unstyled" id="Agenda">
                    <li><a href="/fisiopeti/content/paciente/listar-pacientes.php">Agenda do paciente</a></li>
                    <li><a href="/fisiopeti/content/agenda/agenda-profissional.php">Agenda do profissional</a></li>
                    <li><a href="/fisiopeti/content/agenda/agenda.php">Agenda por categoria</a></li>
                    <hr style="margin: 0; border-color: #666;">
                    <li><a href="/fisiopeti/content/agenda/agenda-base-paciente.php">Agenda base paciente</a></li>
                    <li><a href="/fisiopeti/content/agenda/agenda-base-profissional.php">Agenda base profissional</a></li>
                    <li><a href="/fisiopeti/content/agenda/criar-agenda-da-semana.php">Criar agenda da semana</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="#Convenio" data-toggle="collapse" aria-expanded="false">Convênio</a>
                <ul class="collapse list-unstyled" id="Convenio">
                    <li><a href="/fisiopeti/content/convenio/listar-convenio.php">Listar convênvio</a></li>
                </ul>
            </li>
            ...
            <li><a href="/fisiopeti_aba/content/home">Programa FP&#x271B;</a></li>
            <li><a href="/fisiopeti/content/configuracao/configuracao.php">Configuração</a></li>
            <li><a href="/fisiopeti/content/ajuda" target="blank">Ajuda</a></li>
        </ul>
        <?php
    } else {
        ?>
