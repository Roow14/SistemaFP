...
<div class="col-sm-12">
	...
	// terapeutas ativos
	$sql = "SELECT COUNT(id_profissional) AS TerapeutasAtivos FROM profissional WHERE Status = 1 AND Nivel != 3 ";
	$result = $conn->query($sql);
	if ($result->num_rows > 0) {
		// tem
		while($row = $result->fetch_assoc()) {
	...
	<p>Listar pacientes por unidade <a href="listar-pacientes-por-unidade.php" class="btn btn-default">Avançar</a></p>
</div>
