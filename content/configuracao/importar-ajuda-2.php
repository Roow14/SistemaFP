...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    // buscar xxx
    $sql = "SELECT * FROM fisiofor_agenda.midia_ajuda WHERE ArquivoMidia = '$ArquivoMidia'";
    ...
    $sql = "INSERT INTO fisiofor_agenda.midia_ajuda (ArquivoMidia)
    VALUES ('$ArquivoMidia')";
