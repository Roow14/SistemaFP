...
<h2>Análise pacientes duplicados</h2>
...
<form action="" method="post" class="form-inline">
	...
	<a href="listar-pacientes-duplicados-novo-apagar-matheus.php" class="btn btn-default">Apagar Matheus Santos</a>
</form>
<br>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		$sqlB = "SELECT * FROM paciente WHERE NomeCompleto = '$NomeCompleto' AND id_paciente != '$id_paciente' LIMIT 1";
