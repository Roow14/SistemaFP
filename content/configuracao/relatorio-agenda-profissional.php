...
<ul class="nav nav-tabs">
    ...
    if (!empty($_SESSION['id_paciente'])) {
    	echo '<li class="inactive"><a href="relatorio-agenda-paciente.php">Agenda criança</a></li>';
    }
    ?>
    <li class="active"><a href="relatorio-agenda-profissional.php">Agenda do terapeuta</a></li>
...
<div class="janela">
	<form action="" method="post" class="form-inline" style="margin-bottom: 15px;">
		<div class="form-group" style="margin-right: 15px;">
			<label>Terapeuta:</label> <?php echo $NomeProfissional;?>
		</div>
