...
if ($result->num_rows > 0) {
	...
	if (empty($_SESSION['Status'])) {
		$_SESSION['Status'] = 2;
		echo '<form action="relatorio-agenda-do-dia-status-realizado-2.php" method="post">';
	} elseif ($_SESSION['Status'] == 1) {
		echo '<form action="relatorio-agenda-do-dia-status-agendado-2.php" method="post">';
	} elseif ($_SESSION['Status'] == 3) {
		echo '<form action="relatorio-agenda-do-dia-status-faltou-2.php" method="post">';
	} elseif ($_SESSION['Status'] == 4) {
		echo '<form action="relatorio-agenda-do-dia-status-cancelado-2.php" method="post">';
	} else {
		echo '<form action="relatorio-agenda-do-dia-status-realizado-2.php" method="post">';
	}
	...
	if ($_SESSION['Status'] == 1) {
		echo '<th><button type="submit" class="btn btn-primary" >Agendado</button></th>';
	} elseif ($_SESSION['Status'] == 3) {
