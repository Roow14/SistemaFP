...
<div id="conteudo">
    ...
    <div class="row">
	    <div class="col-lg-6">
	    	<?php
			// buscar xxx
			$sql = "SELECT * FROM prog_treino_paciente";
			...
			if ($result->num_rows > 0) {
			    ...
			    while($row = $result->fetch_assoc()) {
					...
					echo '<td style="vertical-align: middle;"><a href="../paciente/paciente.php?id_treino_paciente='.$id_treino_paciente.'&id_paciente='.$id_paciente.'" class="Link">'.$NomeCompleto.'</a></td>';
					echo '<td><a href="treino.php?id_treino_paciente='.$id_treino_paciente.'&id_paciente='.$id_paciente.'" class="btn btn-default">Abrir</a></td>';
					echo '</tr>';
			    }
			    echo '</tbody>';
				echo '</table>';
