...
<div class="">
	...
	<form action="aplicar-filtro-lista-profissionais-intervencao.php" method="post" class="form-inline">
	...
	if ($result->num_rows > 0) {
	    ...
	    while($row = $result->fetch_assoc()) {
			...
			echo '<td>';
			echo '<a href="agenda-profissional.php?id_profissional='.$id_profissional.'" class="btn btn-default">Ver agenda</a>';
			echo '</td>';
...
<div>
    ...
    <form action="../configuracao/configurar-itens-por-pagina-2.php?Origem=../intervencao/listar-profissionais-intervencao.php" method="post" class="form-inline">
